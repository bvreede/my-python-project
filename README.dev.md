...
git clone git@github.com:bvreede/my-python-project .
...
Don't forget to also make a [release on GitHub](git@github.com:bvreede/my-python-project/releases/new). If your repository uses the GitHub-Zenodo integration this will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.
