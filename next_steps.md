...
git branch -M main
git remote add origin git@github.com:bvreede/my-python-project
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/bvreede/repositories/new](https://github.com/organizations/bvreede/repositories/new)
...
automatically ([here](git@github.com:bvreede/my-python-project/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
